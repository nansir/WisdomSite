...
/**
 * Created by zhuyinan on 2019/9/2.
 */
public class PhotoZoomInfo {
    ...
    public PhotoZoomInfo(RectF rect, RectF img, RectF widget, RectF base, PointF screenCenter, float scale, float degrees, ImageView.ScaleType scaleType) {
        mRect.set(rect);
        mImgRect.set(img);
