...
public class ProgressView extends ProgressBar {
    ...
    private void obtainStyledAttributes(AttributeSet attrs) {
        ...
        final TypedArray attributes = getContext().obtainStyledAttributes(attrs, R.styleable.ProgressView);
        mTextColor = attributes.getColor(R.styleable.ProgressView_progress_text_color, DEFAULT_TEXT_COLOR);
        mTextSize = (int) attributes.getDimension(R.styleable.ProgressView_progress_text_size, mTextSize);

        mReachedBarColor = attributes.getColor(R.styleable.ProgressView_progress_reached_color, mTextColor);
        mUnReachedBarColor = attributes.getColor(R.styleable.ProgressView_progress_unreached_color, DEFAULT_COLOR_UNREACHED_COLOR);
        mReachedProgressBarHeight = (int) attributes.getDimension(R.styleable.ProgressView_progress_reached_bar_height, mReachedProgressBarHeight);
        mUnReachedProgressBarHeight = (int) attributes.getDimension(R.styleable.ProgressView_progress_unreached_bar_height, mUnReachedProgressBarHeight);
        mTextOffset = (int) attributes.getDimension(R.styleable.ProgressView_progress_text_offset, mTextOffset);
        int textVisible = attributes.getInt(R.styleable.ProgressView_progress_text_visibility, VISIBLE);
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        String text = String.valueOf(getProgress());//设置文本
