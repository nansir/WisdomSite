...
public class CameraManager {
    ...
    private CameraListener camera2Listener;
    ...
    private CameraManager(CameraManager.Builder builder) {
    ...
    private void setUpCameraOutputs(android.hardware.camera2.CameraManager cameraManager) {
        try {
    ...
    private boolean configCameraParams(android.hardware.camera2.CameraManager manager, String cameraId) throws CameraAccessException {
